package tw.edu.pu.csim.s1120321.composefirestore.application
...
import tw.edu.pu.csim.s1120321.composefirestore.application.ui.theme.ComposeFireStoreApplicationTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContent {
            ComposeFireStoreApplicationTheme {
...
fun Birth(m: Modifier){
    var userName by remember { mutableStateOf("洪藝文")}
